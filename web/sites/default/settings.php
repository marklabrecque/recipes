 ...
 * @endcode
 */
$settings['hash_salt'] = 'jE09RcAEQRGy2J32DOKUpQh9p8AXI1KoD7ipQDPKxWzXD1H3tBD-Lc348yU-paGW_aep8GbFXQ';
...
# }
if (file_exists(__DIR__ . '/settings.inc')) {
  include __DIR__ . '/settings.inc';
}
